...
import 'package:upkeep/entities/logger_message.entity.dart';
import 'package:upkeep/entities/store.entity.dart';

/// [UpkeepLogger] is a custom logger that is built on top of the [logging] package.
...
class UpkeepLogger {
  static final UpkeepLogger _instance = UpkeepLogger._internal();
  final maxLogEntries = 500;
  final Isar _db = Isar.getInstance()!;
  List<LoggerMessage> _msgBuffer = [];
  Timer? _timer;

  factory UpkeepLogger() => _instance;

  UpkeepLogger._internal() {
